...
def analyze_coin(
    ...
    # =====================================================
    # 80/20 ÇELİŞKİ FİLTRESİ
    # =====================================================

    # Ana trend ile 4H ters ise
    # güçlü sinyali azalt.
...
def should_alert(result):
    ...
    # Güç seviyesine göre grupla.
    # Aynı coin çok küçük skor değişimleriyle
    # tekrar tekrar alarm üretmesin.
